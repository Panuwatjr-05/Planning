  ...
  return (
    <div className="bg-card border border-border rounded-xl overflow-hidden">
      ...
      <div className="p-4 space-y-2.5">
        ...
        <div className="h-3 bg-muted animate-pulse rounded w-1/2 opacity-60" />
        <div className="h-px bg-border mt-3" />
        <div className="h-3 bg-muted animate-pulse rounded w-1/3 opacity-40" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="space-y-8">
      <div className="pb-2 border-b border-border space-y-2">
        ...
        <div className="h-3.5 w-48 bg-muted animate-pulse rounded opacity-50" />
      </div>
